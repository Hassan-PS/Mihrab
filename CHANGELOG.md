...
- **The sky behind the countdown follows the prayer day.** A drawn sky — night before Fajr, the dawn band before sunrise, a clear morning, the afternoon's warm light, the sunset, dusk — with the sun or a crescent moving through the top of the hero with the current interval. It is true to the hour, not to the theme: night is dark at night in a light app and noon is bright at noon in a dark one, whatever Material You has done to the accent. The hero's text takes its ink from the sky rather than the theme, so it reads on every one of them.
