...
- **Redistribute unmodified builds under the name Mihrab.** F-Droid, Google
  Play, the App Store, Obtainium, Homebrew, a mirror, a friend with a USB
  stick — if the app is built from unmodified source, it is Mihrab and may say
  so. This permission is deliberate and permanent: a policy that forced
  distributors to rename the app would make Mihrab useless to F-Droid, which
  is exactly where the users who care most about this project find it.
...
- Publishing a **modified** version under the name Mihrab, or under a name
  likely to be confused with it, on any store or download page.
