...
Daily prayer times, Qibla compass, and related tools — built with [**React Native**](https://reactnative.dev).

**[Releases — download APK](https://github.com/Hassan-PS/PrayerApp/releases)** · [![Latest release](https://img.shields.io/github/v/release/Hassan-PS/PrayerApp?label=version&logo=github)](https://github.com/Hassan-PS/PrayerApp/releases)
